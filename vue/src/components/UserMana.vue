      ...
      <el-card style="width:330px;margin-top: 10px;" v-for="(user,index) in users" :key="index"
        ...
        <div>
          ...
          <div style="text-align: left;color:#20a0ff;font-size: 12px;margin-top: 13px">
           ...
           <div style="text-align: left;color:#20a0ff;font-size: 12px;margin-top: 13px">
            <span>学号:</span><span>{{user.usernumber}}</span>
          </div>
           <!-- <div style="text-align: left;color:#20a0ff;font-size: 12px;margin-top: 13px">
            <span>密码:</span><span>{{user.password}}</span>
          </div> -->
          <div style="text-align: left;color:#20a0ff;font-size: 12px;margin-top: 13px">
            <span>专业:</span><span>{{user.major}}</span>
          </div>
          <div style="text-align: left;color:#20a0ff;font-size: 12px;margin-top: 13px">
            <span>实习单位:</span><span>{{user.practicecompany}}</span>
          </div>
          <div style="text-align: left;color:#20a0ff;font-size: 12px;margin-top: 13px">
